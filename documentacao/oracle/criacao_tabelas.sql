...
--
ALTER TABLE portal_projetos.JUSTIFICATIVA DROP CONSTRAINT FRK_CD_SOL;
--
ALTER TABLE portal_projetos.ACESSO DROP CONSTRAINT FRK_CD_PORTFOLIO;
...
--FOREIGN_KEY
CONSTRAINT FK_CD_RESPONSAVEL FOREIGN KEY (CD_RESPONSAVEL) REFERENCES RESPONSAVEL(CD_RESPONSAVEL),
...
--FOREIGN_KEY
CONSTRAINT FK_CD_PERGUNTA  FOREIGN KEY (CD_PERGUNTA) REFERENCES PERGUNTA(CD_PERGUNTA)
...
--FOREIGN_KEY
CONSTRAINT FRK_CD_PERGUNTA FOREIGN KEY (CD_PERGUNTA) REFERENCES PERGUNTA(CD_PERGUNTA)
...
--FOREIGN_KEY
CONSTRAINT FRK_CD_SOL FOREIGN KEY (CD_SOL) REFERENCES SOLICITACAO(CD_SOLICITACAO)
...
--FOREIGN_KEY
CONSTRAINT FRK_CD_PORTFOLIO FOREIGN KEY (CD_PORTFOLIO) REFERENCES PORTFOLIO(CD_PORTFOLIO)
