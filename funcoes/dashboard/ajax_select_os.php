<?php 
    ...
    $querry =   "SELECT atd_mes.MES,
                ...
                WHERE EXTRACT(YEAR FROM atd.DT_ATENDIMENTO) = 2023
                ORDER BY EXTRACT(MONTH FROM atd.DT_ATENDIMENTO) ASC) atd_mes

                LEFT JOIN(SELECT EXTRACT(MONTH FROM solmv.DT_EXECUCAO) AS MES,
                    ...
                    GROUP BY EXTRACT(MONTH FROM solmv.DT_EXECUCAO))qtd_sol
