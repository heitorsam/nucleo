            ...
            <div class="col-6 col-md-3 col-lg-2 col-sm-6" style="margin: 0px !important; background-color: #ffffff !important;">
                ...
                data-toggle="modal" data-target="#detalhejust<?php echo $i;?>">
                    ...
                    <?php }else{ ?>
                            ...
                            <div style=" cursor: pointer; border-radius: 5px; background-color: #f2f3f5; height: 100px;" onclick="ajax_exibe_detalhes('<?php echo $row_galeria['CD_PORTFOLIO'] ?>')">


                                <div class="efeito-zoom"  style="height: 100px; width: 90%; margin: 0 auto;
...
text-shadow: 0.05em 0.05em 0.1em #dc3545;

}

.botoes_apagar_modal:hover{
