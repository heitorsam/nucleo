                ...
                <div class="menu_azul_claro">
                    ...
                    <div class="menu_preto">
                        <li class="nav-item dropdown">
                            ...
                            <!--MENU-->
                                <a class="dropdown-item" href="solicitacao.php"><i class="fa-solid fa-file-circle-plus"></i> Solicitação</a>   
                                <?php if($_SESSION['SN_ADM'] == 'S'){?> 
                                    
                                    <a class="dropdown-item" href="responsaveis.php"><i class="fa-solid fa-users"></i> Responsaveis</a>   
